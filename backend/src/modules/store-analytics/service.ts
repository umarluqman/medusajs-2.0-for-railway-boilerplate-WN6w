import { Logger, RegionDTO } from "@medusajs/types";
...
export default class StoreAnalyticsModuleService {
  ...
  async getCustomersHistory(
    ...
    return this.customersAnalyticsService_.getHistory(
      from,
      to,
  ...
  async getCustomersNewCount(
    from?: Date,
    to?: Date,
    dateRangeFromCompareTo?: Date,
    dateRangeToCompareTo?: Date
  ) {
    return this.customersAnalyticsService_.getNewCount(
      from,
      to,
      dateRangeFromCompareTo,
      dateRangeToCompareTo
  ...
  async getCustomersCumulativeHistory(
    from?: Date,
    to?: Date,
    dateRangeFromCompareTo?: Date,
    dateRangeToCompareTo?: Date
  ) {
    return this.customersAnalyticsService_.getCumulativeHistory(
      from,
      to,
      dateRangeFromCompareTo,
      dateRangeToCompareTo
  ...
  async getCustomersRetentionRate(
    ...
    return this.customersAnalyticsService_.getRetentionRate(
      orderStatuses,
      from,
      to,
      dateRangeFromCompareTo,
  ...
  async getCustomersRepeatRate(
    ...
    return this.customersAnalyticsService_.getRepeatCustomerRate(
      orderStatuses,
      from,
      to,
      dateRangeFromCompareTo,
  ...
  async getOrdersSales(
    ...
    return this.salesAnalyticsService_.getOrdersSales(
      orderStatuses,
      currencyCode,
      from,
      to,
  ...
  async getSalesChannelsPopularity(
    orderStatuses: OrderStatus[],
    from?: Date,
    to?: Date,
    dateRangeFromCompareTo?: Date,
    ...
    return this.salesAnalyticsService_.getSalesChannelsPopularity(
      orderStatuses,
      from,
      to,
      dateRangeFromCompareTo,
  ...
  async getSalesRegionsPopularity(
    orderStatuses: OrderStatus[],
    from?: Date,
    to?: Date,
    dateRangeFromCompareTo?: Date,
    ...
    return this.salesAnalyticsService_.getRegionsPopularity(
      orderStatuses,
      from,
      to,
      dateRangeFromCompareTo,
  ...
  async getSalesRefunds(
    ...
    return this.salesAnalyticsService_.getRefunds(
      currencyCode,
      from,
      to,
      dateRangeFromCompareTo,
  ...
  // Products
  async getProductsTopVariantsByCount(
    orderStatuses: OrderStatus[],
    from?: Date,
    to?: Date,
    dateRangeFromCompareTo?: Date,
    ...
    return this.productsAnalyticsService_.getTopVariantsByCount(
      orderStatuses,
      from,
      to,
      dateRangeFromCompareTo,
  ...
  async getProductsSoldCount(
    ...
    return this.productsAnalyticsService_.getProductsSoldCount(
      orderStatuses,
      from,
      to,
      dateRangeFromCompareTo,
  ...
  async getProductsTopReturnedVariantsByCount(from?: Date, to?: Date) {
    return this.productsAnalyticsService_.getTopReturnedVariantsByCount(
      from,
      to
    );
  }
  ...
  // Marketing
  async getMarketingTopDiscounts(
    orderStatuses: OrderStatus[],
    from?: Date,
    to?: Date
  ) {
    return this.marketingAnalyticsService_.getTopDiscountsByCount(
      orderStatuses,
      from,
      to
    );
  ...
  async getOrdersHistory(
    ...
    return this.ordersAnalyticsService_.getOrdersHistory(
      orderStatuses,
      from,
      to,
      dateRangeFromCompareTo,
  ...
  async getOrdersPaymentProviderPopularity(
    from?: Date,
    to?: Date,
    dateRangeFromCompareTo?: Date,
    dateRangeToCompareTo?: Date
  ) {
    return this.ordersAnalyticsService_.getPaymentProviderPopularity(
      from,
      to,
      dateRangeFromCompareTo,
      dateRangeToCompareTo
  ...
  async generateReport(
    ...
    const ordersHistory = await this.ordersAnalyticsService_.getOrdersHistory(
      orderStatuses,
      from,
      to,
      dateRangeFromCompareTo,
    ...
    const customerHistory = await this.customersAnalyticsService_.getHistory(
      from,
      to,
      dateRangeFromCompareTo,
      dateRangeToCompareTo
    );
    const variantsCountPopularityResult =
      await this.productsAnalyticsService_.getTopVariantsByCount(
        orderStatuses,
        from,
        to,
        dateRangeFromCompareTo,
    ...
    for (const region of regions) {
      salesAnalyticsResults.push(
        await this.salesAnalyticsService_.getOrdersSales(
          orderStatuses,
    ...
    return this.reportsAnalyticsService_.generateReport(
      orderStatuses,
      {
